...
export const advisors = [
  { name: "Dr. Nayda Santiago", role: "Research advisor", focus: "Digital media, machine learning, and research direction", photo: "/images/professors/nayda-santiago.png" },
  { name: "Dr. Alcibiades Bustillo", role: "Research advisor", focus: "Computer science mentorship and experimental context", photo: "/images/professors/alcibiades-bustillo.png" },
];
...
export const members: TeamMember[] = [
  ...
  memberSlot("Diego Espinal", "Learning path member", "DE"),
  memberSlot("Sorimerlin Santos", "Learning path member", "SS"),
  memberSlot("Aliek Betancourt", "Learning path member", "AB"),
  memberSlot("Héctor López", "Learning path member", "HL"),
  memberSlot("Kelvin Soto", "Learning path member", "KS"),
  memberSlot("Ian Figueroa", "Learning path member", "IF"),
  memberSlot("Fernando Velez", "Learning path member", "FV"),
  memberSlot("Jayden Sanchez", "Learning path member", "JS"),
  memberSlot("Frances Sola", "Learning path member", "FS"),
  memberSlot("Ian Banks", "Learning path member", "IB"),
  memberSlot("Adríana Vega", "Learning path member", "AV"),
  memberSlot("Jerremy Aponte", "Learning path member", "JA"),
  memberSlot("Josue López", "Learning path member", "JL"),
  memberSlot("Kiara Jimenez", "Learning path member", "KJ"),
  memberSlot("Daniel Muñoz", "Learning path member", "DM"),
